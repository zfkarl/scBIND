...
from utils.dataset import CellTextDataModule_GSE149383
...
if __name__ == "__main__":
    ...
    # Dataset
    parser.add_argument("--rna_text_path", type=str, default='dataset/sc-data/data/4o_text_embeddings_GSE149383_Erlotinib.npy')
    parser.add_argument("--gene_emb_path", type=str, default='dataset/sc-data/data/GSE149383_Erlotinib-gene-emb.npy')
    # DataModule
    parser.add_argument("--batch_size", type=int, default=512)
    parser.add_argument("--num_workers", type=int, default=4)
    parser.add_argument("--data_dir", type=str, default="erlotinib-4o")
    ...
    parser.add_argument("--version", type=str, default="erlotinib")
    ...
    if args.checkpoint is None:
        ...
        rna_data = CellTextDataModule_GSE149383(args.batch_size,args.rna_text_path, args.gene_emb_path)
