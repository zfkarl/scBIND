...
if __name__ == "__main__":
    ...
    # Dataset
    parser.add_argument("--rna_data_path", type=str, default='dataset/sc-data/data/citeseq_control_rna.npz')
    parser.add_argument("--rna_text_path", type=str, default='dataset/sc-data/data/4o_text_embeddings_cite.npy')
    parser.add_argument("--rna_label_path", type=str, default='dataset/sc-data/data/citeseq_control_cellTypes.txt')
    parser.add_argument("--gene_emb_path", type=str, default='dataset/sc-data/data/4o-cite-asap-gene-emb.npy')
    # DataModule
    parser.add_argument("--batch_size", type=int, default=512)
    parser.add_argument("--num_workers", type=int, default=4)
    parser.add_argument("--data_dir", type=str, default="cite-4o")
