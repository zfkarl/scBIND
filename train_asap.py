...
from utils.dataset import CellTextDataModule
...
if __name__ == "__main__":
    ...
    # Dataset
    parser.add_argument("--atac_data_path", type=str, default='dataset/sc-data/data/asapseq_control_atac.npz')
    parser.add_argument("--atac_text_path", type=str, default='dataset/sc-data/data/4o_text_embeddings_asap.npy')
    parser.add_argument("--atac_label_path", type=str, default='dataset/sc-data/data/asapseq_control_cellTypes_v2.txt')
    parser.add_argument("--gene_emb_path", type=str, default='dataset/sc-data/data/4o-cite-asap-gene-emb.npy')
    # DataModule
    parser.add_argument("--batch_size", type=int, default=512)
    parser.add_argument("--num_workers", type=int, default=4)
    parser.add_argument("--data_dir", type=str, default="asap-4o")
